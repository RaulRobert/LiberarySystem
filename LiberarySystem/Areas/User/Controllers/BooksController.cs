...
namespace LiberarySystem.Areas.User.Controllers
{
    [Area("User")]
    public class BooksController : Controller
    {
        ...
        {
            var availableBooks = await _bookBO.GetAvailableBooksAsync();
        ...
        {
            int authenticationId = 1; // Replace with real logged-in user later
            var myBorrows = await _bookBO.GetUserBorrowsAsync(authenticationId);
